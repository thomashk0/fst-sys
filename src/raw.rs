...
impl fstHier__bindgen_ty_1_fstHierVar {
    #[inline]
    pub fn is_alias(&self) -> ::std::os::raw::c_uint {
        unsafe { ::std::mem::transmute(self._bitfield_1.get(0usize, 1u8) as u32) }
    }
    #[inline]
    pub fn set_is_alias(&mut self, val: ::std::os::raw::c_uint) {
        unsafe {
    ...
    pub fn new_bitfield_1(
        is_alias: ::std::os::raw::c_uint,
    ) -> __BindgenBitfieldUnit<[u8; 1usize], u8> {
        let mut __bindgen_bitfield_unit: __BindgenBitfieldUnit<[u8; 1usize], u8> =
            Default::default();
        __bindgen_bitfield_unit.set(0usize, 1u8, {
            let is_alias: u32 = unsafe { ::std::mem::transmute(is_alias) };
            is_alias as u64
        });
